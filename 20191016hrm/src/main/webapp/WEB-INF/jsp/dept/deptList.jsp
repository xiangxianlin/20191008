...
<head>
	...
	<script type="text/javascript">
		...
		var deleteFn = function(id){
			if (confirm('您确定要删除吗？')){
				window.location = "${pageContext.request.contextPath}/dept/deleteDept?id=" + id;
			}
		};
	</script>
</head>
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
		  ...
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
		    <tr class="main_trbg_tit">
			  ...
			  <c:forEach items="${depts}" var="dept">
				  <tr class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					  ...
					  <td>${dept.name}</td>
					  <td>${dept.remark}</td>
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/dept/toUpdateDept?id=${dept.id}">
						  <img title="修改" src="${pageContext.request.contextPath}/images/update.gif"/></a>
					  </td>
					  <td align="center"  width="40px;">
						  <a href="javascript:void(0);" onclick="deleteFn('${dept.id}');">
			...
			<%--<s:iterator value="depts">
				<tr class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
				  ...
				  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/dept/updateDept?id=${id}">
						<img title="修改" src="${pageContext.request.contextPath}/images/update.gif"/></a>
				  </td>
				  <td align="center"  width="40px;">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  		<fkjava:pager pageIndex="${pageModel.pageIndex}" 
	  		              ...
	  		              submitUrl="${pageContext.request.contextPath}/dept/selectDept/{0}.html"/>
	  </td></tr>
	</table>
